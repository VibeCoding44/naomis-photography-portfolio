            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row gap-16 justify-center max-w-4xl mx-auto">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <p className="text-[#9a9189] font-light text-lg mb-12">
                            Interested in working together? I'd love to hear from you. Please reach out directly or book a session.
                        </p>

                        <div className="space-y-8">
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-[#6f6862] mb-2">Email</h3>
                                <p className="text-xl break-all">{CONTACT_INFO.email}</p>
                            </div>
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-[#6f6862] mb-2">Phone</h3>
                                <p className="text-xl">
                                    <a href={`tel:${CONTACT_INFO.phoneE164}`} className="hover:text-[#b07a52] transition-colors border-b border-transparent hover:border-[#b07a52]">{CONTACT_INFO.phone}</a>
                                </p>
                            </div>
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-[#6f6862] mb-2">Location</h3>
                                <p className="text-xl">{CONTACT_INFO.location}</p>
                            </div>
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-[#6f6862] mb-2">Social</h3>
                                <div className="flex gap-4">
                                    <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-[#b07a52] transition-colors border-b border-transparent hover:border-[#b07a52]">Instagram</a>
                                </div>
                            </div>
                        </div>
                    </div>
