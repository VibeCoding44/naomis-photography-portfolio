...
export const metadata: Metadata = {
    title: "Wedding & Portrait Portfolio",
    description: "A curated portfolio of fine art wedding, portrait, and commercial photography in Plant City, Tampa, and Central Florida.",
    alternates: {
        canonical: "/portfolio",
    },
};
