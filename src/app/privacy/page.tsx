                    ...
                    <div className="space-y-10 text-white/70 font-light leading-relaxed text-lg">
                        <section className="space-y-4">
                            <p>
                                ...
                                visit{" "}
                                <Link href="/" className="text-white underline underline-offset-4 decoration-white/30 hover:decoration-white">
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Information We Collect</h2>
                            <p>
                                <strong className="text-white/90 font-normal">Information you give us.</strong>{" "}
                            ...
                            <p>
                                <strong className="text-white/90 font-normal">Information collected automatically.</strong>{" "}
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Analytics &amp; Advertising Tools</h2>
                            <p>We rely on a small number of trusted third-party services:</p>
                            <ul className="space-y-3 list-disc pl-6 marker:text-white/30">
                                <li>
                                    <strong className="text-white/90 font-normal">Google Analytics &amp; Google Tag Manager</strong>{" "}
                                    — to measure site traffic and understand which pages are helpful to
                                    visitors.
                                </li>
                                <li>
                                    <strong className="text-white/90 font-normal">Pinterest Tag</strong>{" "}
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">How We Use Your Information</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Your Choices</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Third-Party Links</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Children&rsquo;s Privacy</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            <h2 className="font-serif text-3xl text-white">Changes to This Policy</h2>
                            <p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                ...
                                <a
                                    ...
                                    className="text-white underline underline-offset-4 decoration-white/30 hover:decoration-white break-all"
                                >
                                    {CONTACT_INFO.email}
                                </a>{" "}
                                or visit our{" "}
